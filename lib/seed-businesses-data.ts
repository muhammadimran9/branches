...
// Email fields are intentionally left blank so no accidental emails are sent.
...
export const SEED_BUSINESSES: SeedBusiness[] = [
  ...
  { name: "Coocos Den and Cafe", category: "restaurants", city: "Lahore", address: "Food Street, Fort Road, Walled City, Lahore", phone: "042 3735 8485", desc: "Iconic rooftop restaurant inside a restored haveli, serving traditional Lahori food with a clear view of the Badshahi Mosque." },
  ...
  // ===== Technology & IT (5) =====
  { name: "NetSol Technologies", category: "technology", city: "Lahore", address: "NetSol Avenue, Ghazi Road, Lahore Cantt", phone: "042 111 438 076", desc: "Global IT solutions provider delivering asset finance and leasing software, digital transformation and enterprise services." },
  ...
  { name: "NUST Islamabad", category: "education", city: "Islamabad", address: "H-12, Islamabad", phone: "051 9085 1900", desc: "National University of Sciences and Technology - top-ranked university for engineering, computing and sciences." },
  ...
  // ===== Travel & Tourism (4) =====
  { name: "Travel Waljis", category: "travel", city: "Islamabad", address: "10-Khayaban-e-Suhrwardy, Aabpara, Islamabad", phone: "051 287 8342", desc: "IATA-accredited travel agency offering airline ticketing, Umrah packages, Europe tours and visa services." },
  ...
  { name: "TCS Express and Logistics", category: "logistics", city: "Karachi", address: "TCS Head Office, Plot 113, Sector 24, Korangi, Karachi", phone: "021 111 123 456", desc: "Pakistan's leading courier and logistics company offering overnight delivery, e-commerce and freight services." },
  ...
  { name: "M and P Express Logistics", category: "logistics", city: "Hyderabad", address: "Auto Bhan Road, Latifabad, Hyderabad", phone: "022 381 1011", desc: "Muller and Phipps logistics offering parcel delivery, warehousing and cash-on-delivery for online stores." },
]
